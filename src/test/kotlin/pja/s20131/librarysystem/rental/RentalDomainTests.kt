...
import pja.s20131.librarysystem.domain.resource.model.CannotBeReservedToBorrowException
...
class RentalDomainTests {
    ...
    fun `should throw exception when trying to reserve to borrow a not-book resource`() {
        ...
        assertThrows<CannotBeReservedToBorrowException> { ebook.reserveToBorrow(UserId.generate(), LibraryId.generate(), Instant.now()) }
    }
}
