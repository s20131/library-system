...
DO $$
    DECLARE library_id1 uuid;
    DECLARE library_id2 uuid;
    DECLARE library_id3 uuid;
    DECLARE author_id uuid;
    DECLARE book_id uuid;
    DECLARE ebook_id uuid;
    DECLARE user_id uuid;
BEGIN
    library_id1 := gen_random_uuid();
    library_id2 := gen_random_uuid();
    library_id3 := gen_random_uuid();
    author_id := gen_random_uuid();
    ebook_id := gen_random_uuid();
    user_id := uuid('45d859ad-d03d-4a3b-ba59-31ae20a99992');

    INSERT INTO library VALUES (library_id1, 'Biblioteka Publiczna w Dzielnicy Wesoła - Filia Nr 1', 'Jana Pawła II', '25', '05-077', 'Warszawa', st_point(21.23889248476246, 52.21644380014136));
    INSERT INTO library VALUES (library_id2, 'Biblioteka Dzielnicowa Warszawa Wesoła', '1 Praskiego Pułku', '31', '05-075', 'Warszawa', st_point(21.22411093615883, 52.24838074876337));
    INSERT INTO library VALUES (library_id3, 'Biblioteka Uniwersytecka w Warszawie', 'Dobra', '56/66', '00-312', 'Warszawa', st_point(21.02521989189416, 52.24268951970279));
    ...
    INSERT INTO copy (library_id, resource_id, available) VALUES (library_id1, ebook_id, 3);
    INSERT INTO copy (library_id, resource_id, available) VALUES (library_id2, ebook_id, 2);
    INSERT INTO copy (library_id, resource_id, available) VALUES (library_id3, ebook_id, 1);
    INSERT INTO copy (library_id, resource_id, available) VALUES (library_id1, book_id, 3);
    INSERT INTO copy (library_id, resource_id, available) VALUES (library_id3, book_id, 0);
