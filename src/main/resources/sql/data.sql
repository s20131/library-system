...
BEGIN
    ...
    INSERT INTO resource(id, title/*, author*/, release_date, series) VALUES (wiedzmin2_id, ''Pani Jeziora''/*, sapkowski_id*/, CURRENT_DATE, ''Wiedźmin'');
